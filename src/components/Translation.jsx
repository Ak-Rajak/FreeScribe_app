...
export default function Translation(props) {
    const [translation , toLanguage , translating , setToLanguage , setTranslating , setTranslation] = props
    ...
    <div className="flex flex-col gap-2 max-w-[400px] w-full mx-auto ">
      <div className="flex flex-col ">
        ...
        <div className="flex item-stretch gap-2">
            ...
            <button className='flex px-2 py-3 rounded-lg text-blue-400 hover:text-blue-600 duration-200'>Translate</button>
        </div>
      </div>
    </div>
  )
